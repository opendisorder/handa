...
Copy
Share
Synthesize Documents into Cohesive TTS Friendly Narrative
Execute Python code
Caregiver Perspective What Makes It Truly Special for Families
...
The summary shows:
✅ Correct: 16/20
⭐ Excellent: 8 | 👍 Good: 5 | 🔄 Retried: 3 | ⏭ Skipped: 1
Notice: no "wrong" column. No red number. No failure count.
Then the comparison that matters:
"ගෙවී ගිය සතියට වඩා ඔබ 12% වැඩිදියුණු වී ඇත!" — You improved 12% from last week!
Highlights:
🏆 Best today: "බ්‍රොකොලි ✅ 3/3"
🎯 Needs practice: "ත්‍රිකෝල ← try tomorrow" — framed as future opportunity, not past failure
Then a final breathing exercise. And a warm farewell:
...
Exercise Selection
Eight large cards representing different cognitive skills:
Category Naming — "Name 10 fruits"
Letter Fluency — "Words starting with 'ක'"
Memory Recall — Remember 3 words, recall after 2 minutes
Object Description — "Describe a mango"
Daily Sentences — "What would you say if you wanted water?"
Opposites — "What is the opposite of hot?"
Story Completion — "A boy went to the market and bought..."
Breathing + Speech — "Take a breath, then say 'watermelon' slowly"
...
"ඔබ ඉතා හොඳ කාර්ය සාධනයක් දැක්වූවා. ත්‍රිකෝල සහ අන්නාසි ටිකක් ගෙනෙන්නට ඔබට අමාරු විය. ඒ ගෙඩි හෙට ප්‍රගුණ කරමු."
"You performed very well. Watermelon and pineapple were slightly harder. Let's practice those tomorrow."
...
40% mastered words — confidence anchors. He starts with success.
40% practicing words — core work.
20% new words — gentle growth.
...
Language Unlocking
Not random from day one. Progressive:
Level 1: Sinhala only (default)
Level 2: + Tamil unlocks at 70% Sinhala accuracy for 3 days — celebrated: "🎉 නව භාෂාවක් විවෘත විය!"
Level 3: + English at 70% Tamil accuracy
Level 4: Full random mix (caregiver-enabled)
Language switching is cognitive flexibility training — it strengthens executive function, which benefits stroke recovery.
Fatigue Detection
The app tracks: session length, accuracy drop-off points, pause lengthening, morning vs. evening performance. If he is tiring:
"ඔබට අද ටිකක් වෙහෙසයි වගේ. අපි හෙට හමුවෙමුද?" (You seem tired. Shall we meet tomorrow?)
...
Weekly Overview
Week of June 3–9
📅 Sessions: 5/7 days | ⏱ Time: 1hr 42min | 🎯 Accuracy: 76% | 📈 Improvement: +8%
...
Breathing exercises	Anxiety tightens throat/jaw. Breathing is not calming decoration — it directly improves speech ability.
Four-outcome scoring	Rewarding "almost" tells his brain effort is valid. Prevents the despair that makes patients quit.
40% mastered start	Behavioral activation — success breeds motivation. He never begins cold and frustrated.
No "wrong" on screen	Shame destroys therapy relationships. The app only shows progress directions.
Using his name	"අපූරුයි, කමල්!" builds an emotional bond. He looks forward to the app because it knows him.
Offline fallback	One crash can make an elderly patient distrust the app forever. Graceful degradation protects the relationship.
Micro-breathing after correct answers	Prevents rushing. Gives the brain time to consolidate success. Keeps the nervous system calm.
